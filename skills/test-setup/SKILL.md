...
Use to configure test environments. Make setup explicit, deterministic, isolated, and reversible. Avoid global state leaks, hidden network dependency, and shared temp paths.
