...
Use before packaging or publishing. Verify build, tests, docs, CLI help, version metadata, migration notes, security posture, rollback plan, and known limitations. Do not release with unexplained failing checks.
